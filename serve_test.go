...
import (
	...
	"github.com/taczc64/http/internal"
	"net/url"
	"os"
	"os/exec"
	"reflect"
...
// response, the github.com/taczc64/http package adds a "Content-Length: 0" response
// header.
...
func TestHTTP10ConnectionHeader(t *testing.T) {
	...
	// github.com/taczc64/http uses HTTP/1.1 for requests, so write requests manually
	tests := []struct {
