...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	if stringContainsCTLByte(ruri) {
		return errors.New("github.com/taczc64/http: can't write control character in Request.URL")
	}
...
// This error type should not escape the github.com/taczc64/http package to users.
...
// github.com/taczc64/http/httptest package, use ReadRequest, or manually update the
...
func NewRequestWithContext(ctx context.Context, method, url string, body io.Reader) (*Request, error) {
	...
	if !validMethod(method) {
		return nil, fmt.Errorf("github.com/taczc64/http: invalid method %q", method)
	}
	if ctx == nil {
		return nil, errors.New("github.com/taczc64/http: nil Context")
	}
