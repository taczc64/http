...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"github.com/taczc64/http.(*Client).Get":          true,
		"github.com/taczc64/http.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"github.com/taczc64/http.http2Server":           false,
		"github.com/taczc64/http.(*Server).Serve":       false,
		"github.com/taczc64/http.(*ServeMux).ServeHTTP": false,
		"github.com/taczc64/http.DefaultServeMux":       false,
	}
