...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/taczc64/http_test.interestingGoroutines") ||
...
func goroutineLeaked() bool {
	...
	fmt.Fprintf(os.Stderr, "Too many goroutines running after github.com/taczc64/http test(s).\n")
...
func afterTest(t testing.TB) {
	...
	badSubstring := map[string]string{
		...
		"created by github.com/taczc64/http/httptest.(*Server).Start": "an httptest.Server",
