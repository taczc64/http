...
var (
	...
	// anything in the github.com/taczc64/http package. Callers should not
...
// is preferred:
//    https://golang.org/pkg/github.com/taczc64/http/#ResponseWriter
//    https://golang.org/pkg/github.com/taczc64/http/#example_ResponseWriter_trailers
...
// relevantCaller searches the call stack for the first function outside of github.com/taczc64/http.
...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "github.com/taczc64/http.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("github.com/taczc64/http: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.isSet() {
		panic("github.com/taczc64/http: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.isSet() {
		panic("github.com/taczc64/http: CloseNotify called after ServeHTTP finished")
	}
...
// recognized by x/github.com/taczc64/http2 to pass down a context; the TLSNextProto
